...
//	mymob.internals.screen_loc = ui_internal
	...
	mymob.client.screen += list( mymob.zone_sel, mymob.healths, mymob.healthdoll, mymob.blind, mymob.flash, mymob.damageoverlay, mymob.whitenoise, mymob.pulseimage, lingchemdisplay, lingstingdisplay, mymob.staminas) //, mymob.hands, mymob.rest, mymob.sleep) //, mymob.mach )
