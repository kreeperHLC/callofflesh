/obj/item/weapon/storage/stalker/shkaf64
	name = "Shkaf"
	desc = "Большой дерев&#255;нный шкаф. Красивый, но в некоторых местах стерс&#255; и облез, на стекле видны царапины."
...
/obj/item/weapon/storage/stalker/plita
	name = "stove"
	desc = "Ржава&#255; и очень стара&#255; газова&#255; плита. Где-то еще можно различить частички засохшего жира, вперемешку с гр&#255;зью и пылью."
