...
/sidoritem/kombez
	name = "Zarya"
	itemtype = /obj/item/clothing/suit/hooded/kozhanka/kombez
	cost = 22000
...
/sidoritem/ecolog
	name = "SPP-99"
	itemtype = /obj/item/clothing/suit/hooded/kozhanka/ecolog
	cost = 85000
	words = list("Эколога" = 5, "эколога" = 5, "Зеленый" = 5, "зеленый" = 5, "СПП" = 5, "СПП-99" = 5, "99" = 5, "Эколог" = 5, "эколог" = 10)

/sidoritem/ecologm
	name = "SPP-99M"
	itemtype = /obj/item/clothing/suit/hooded/kozhanka/ecologm
	cost = 100000
...
/sidoritem/seva
	name = "Seva"
	itemtype = /obj/item/clothing/suit/hooded/kozhanka/seva
	cost = 80000
	words = list("Севу" = 5, "севу" = 5, "Сева" = 5, "сева" = 5)

/sidoritem/berill
	name = "Berill 5M"
	itemtype = /obj/item/clothing/suit/army/berill
	cost = 40000
...
/sidoritem/army2
	name = "Army Armor 2"
	itemtype = /obj/item/clothing/suit/army/army2
	cost = 8000
	words = list("Армейский" = 5, "армейский" = 5, "Бронежилет" = 5, "бронежилет" = 5)

/sidoritem/psz9d
	name = "PSZ 9D"
	itemtype = /obj/item/clothing/suit/hooded/kozhanka/psz9d
	cost = 60000
	words = list("ПСЗ" = 5, "9Д" = 5, "ПСЗ9Д" = 5, "псз" = 5, "9д" = 5, "псз9д" = 10)

/sidoritem/mercenary
	name = "Mercenary suit"
	itemtype = /obj/item/clothing/suit/hooded/kozhanka/mercenary
	cost = 19000
...
/sidoritem/exoskelet
	name = "Exoskelet"
	itemtype = /obj/item/clothing/suit/hooded/kozhanka/exoskelet
	cost = 120000
	words = list("Экзоскелет" = 5, "экзосклет" = 5, "Экзу" = 5, "экзу" = 5)

/sidoritem/psz9md
	name = "PSZ-9MD"
	itemtype = /obj/item/clothing/suit/hooded/kozhanka/psz9md
	cost = 80000
