...
var/datum/subsystem/lights/SSlighting
var/list/init_turfs = list()
var/list/init_lights = list()
var/datum/subsystem/lights/fire/lights_master
#define MC_AVERAGE(average, current) (0.8*(average) + 0.2*(current))

/datum/subsystem/lights
	name = "Lighting"
	priority = 1
	wait = 10
	dynamic_wait = 1
...
/datum/subsystem/lights/New()
	NEW_SS_GLOBAL(SSlighting)

	return ..()


///datum/subsystem/lights/stat_entry()
...
/datum/subsystem/lights/Initialize(timeofday, z_level)
	name = "lights"
